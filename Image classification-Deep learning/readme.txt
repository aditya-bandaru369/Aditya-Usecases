...
The training and test data sets have 785 columns. The first column consists of the class labels (see above),
...
AIM: Implemented multiclassification using deep learning